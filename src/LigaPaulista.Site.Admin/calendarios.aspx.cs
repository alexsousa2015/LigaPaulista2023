...
{
    public partial class Calendarios : AdminTheme
    {
        ...
        protected void gridCalendario_DataSelect(object sender, EventArgs e)
        {
            Session["id_Calendario"] = (sender as ASPxGridView).GetMasterRowKeyValue();
        }
